...
const LABELS = {
  en: {
    ...
    source: 'Source', actions: 'Click behaviour', scenario: 'Scenario', notes: 'Notes',
  ...
  'zh-CN': {
    ...
    source: '来源', actions: '点击后的行为', scenario: '出自场景', notes: '补充说明',
  ...
  'zh-TW': {
    ...
    source: '來源', actions: '點擊後的行為', scenario: '出自場景', notes: '補充說明',
  ...
  ja: {
    ...
    source: '出典', actions: 'クリック後の挙動', scenario: 'シナリオ', notes: '補足',
